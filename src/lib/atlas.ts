...
/** Stagno, Thatcher, van Someren 2007 five-zone weights, mapped onto zones 0–5. */
...
export function buildAtlas(
  ...
  const stageCite = aetherNight
    ? "Aether sleep from public Heart Rate + HRV — not a sleep study"
    : "AASM scoring; stage summary";
  ...
  const metrics: AtlasMetric[] = [
    ...
    metric({
      ...
      unit: "ms",
      formula: "√ mean of squared successive RR differences (overnight)",
    ...
    metric({
      ...
      value: restHr,
      unit: "bpm",
      formula: "Overnight nadir / resting heart rate",
      citation: "recovery payload; ESC resting HR literature",
      confidence: "measured",
      digits: 0,
    }),
    metric({
    ...
    metric({
      ...
      unit: "bpm",
      formula: "body measurement",
      citation: "body measurement",
      confidence: "measured",
      digits: 0,
    }),
    metric({
    ...
    metric({
      ...
      value: maxHr,
      unit: "bpm",
      formula: "override > measured body > Tanaka",
    ...
    metric({
      ...
      value: stagnoWeek,
      unit: "AU",
      formula: "Σ zone_min × [1.00, 1.25, 1.71, 2.54, 3.61, 5.16] on zones 0–5",
    ...
    metric({
      ...
      citation: "six-zone heart-rate model",
      confidence: "measured",
      digits: 0,
    }),
    metric({
    ...
    metric({
      ...
      citation: "Ainsworth Compendium operationalization of session kilojoule",
    ...
    metric({
      ...
      unit: "%",
      formula: "100 × TST / TIB",
      citation: "AASM; sleep efficiency",
      confidence: "measured",
      digits: 1,
    }),
    metric({
      ...
      citation: aetherNight
        ...
        : "sleep score (ratio of time asleep to need)",
    ...
    metric({
      ...
      unit: "%",
      formula: "sleep consistency",
      citation: "sleep score (schedule regularity)",
      confidence: "measured",
      digits: 0,
    }),
    metric({
      ...
      citation: "sleep need components; Process S analog",
    ...
    metric({
      ...
      citation: "Sleep start (detected, not lights-out)",
    ...
    metric({
      ...
      unit: "count",
      formula: "disturbance count",
      citation: "sleep stage summary",
      confidence: "measured",
      digits: 0,
    }),
    metric({
    ...
    metric({
      ...
      citation: aetherNight ? stageCite : "AASM N1+N2 collapsed as light sleep",
    ...
    metric({
      ...
      unit: "/min",
      formula: "respiratory rate",
      citation: "sleep score",
      confidence: "measured",
      digits: 2,
    }),
    metric({
      ...
      value: sleepDebtH,
      unit: "h",
      formula: "need − TIB, need from sleep need components",
      citation: "Process S (Borbély 1982) operationalized via sleep need",
    ...
    metric({
      ...
      unit: "%",
      formula: "overnight SpO2",
      citation: "overnight SpO2 — not a medical pulse-ox diagnosis",
      confidence: "measured",
      digits: 1,
    }),
    metric({
    ...
    metric({
      ...
      citation: "Relative deviation used in wearable illness research (e.g. wearable)",
      confidence: "derived",
      digits: 2,
    }),
    metric({
    ...
    metric({
      ...
      unit: "%",
      formula: "closed recovery model",
      citation: "recovery score (proprietary)",
      confidence: "measured",
      digits: 0,
    }),
    metric({
      ...
      unit: "AU",
      formula: "cycle strain 0–21",
      citation: "cycle strain (proprietary)",
    ...
    metric({
      id: "whoop-strain7",
      group: "Recovery & risk",
      name: "Strain 7-day mean",
      value: strain7 || null,
      unit: "AU",
      formula: "mean(cycle strain, 7 days)",
      citation: "strain rolling mean",
    ...
    unavailable(
      "dfa",
      "Not measured from public heart rate",
      "DFA a1",
      "Detrended fluctuation analysis of RR during exercise",
      "Gronwald / Rogers / DFA a1 literature",
      "Needs raw beat-to-beat intervals during work. Public heart rate does not include them.",
    ),
    unavailable(
      "ecg",
      "Not measured from public heart rate",
      "ECG / AFib strip",
      "Single-lead ECG",
      "A single-lead ECG stays in the strap app",
    ...
    unavailable(
      ...
      "Workouts may include distance, not a GPS track.",
    ),
    unavailable(
      "power",
      "Not measured from public heart rate",
    ...
    unavailable(
      ...
      "Required for SDNN, pNN50, LF/HF, Poincaré SD1/SD2 from scratch. Only RMSSD is available.",
    ),
    unavailable(
      "latency",
      "Not measured from public heart rate",
      ...
      "Lights-out to N1",
      "AASM SOL",
      "Sleep latency is not separate from time in bed.",
    ),
    unavailable(
      "vo2lab",
      "Not measured from public heart rate",
    ...
    unavailable(
      ...
      "Needs a timed post-exercise heart-rate sample. Workouts do not export a recovery curve.",
    ),
    unavailable(
      "sdnn",
      "Not measured from public heart rate",
      ...
      "Overnight RMSSD is available. SDNN, pNN50, and spectral bands are not.",
    ),
    unavailable(
      "poincare",
      "Not measured from public heart rate",
    ...
    unavailable(
      ...
      "Daytime stress",
      "Daytime stress",
      "Daytime stress in the strap app",
    ...
    unavailable(
      ...
      "Physiological age",
      "Physiological age",
      "Proprietary PAC is not in the API. Aether’s KDM biological age (Lab / Today) is the open substitute — an open estimate.",
    ),
    unavailable(
      "cadence",
      "Not measured from public heart rate",
      ...
      "This stream has no footpod or running-dynamics data.",
    ),
    unavailable(
      "ea-reds",
      "Not measured from public heart rate",
    ...
    unavailable(
      ...
      "AASM scoring manual",
      "Wearable stages are an estimate, not a sleep study.",
    ),
  ];
